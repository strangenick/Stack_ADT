...
public class Driver{
	...
	public static void main (String[] args){
		...
		Stack<Student> studentStack = new Stack<Student>(10);  //creates instance of a Stack of Students by calling the constructor
					...
					if (studentStack.isFull()){  //controls for the case where the user selects this option more than once in a row
						...
						try{
							...
							while (line != null) {
								...
								line = buffer.readLine();  //read next line, and repeat
							}
							buffer.close();
							System.out.println("\nStudents successfully loaded from file!");
							
						//catch the possible IO Exceptions:	
